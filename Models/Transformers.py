...
def transfomerBasedModel(input_shape):
    ...
    transformer_encoder = Encoder(num_layers=2, d_model=512, num_heads=8, dff=512, input_vocab_size=input_shape[0], maximum_position_encoding=input_shape[0])
    t = transformer_encoder(t, True, None)
